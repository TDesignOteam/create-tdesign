        ...
        <div className="topbar-inner">
          ...
          <div className="topbar-actions">
            <Tooltip content="React component documentation">
              <Button tag="a" href={docsUrl} target="_blank" shape="circle" variant="text" aria-label="Open React component documentation">
                <BookOpenIcon />
              </Button>
            </Tooltip>
            <Tooltip content="TDesign React on GitHub">
              <Button tag="a" href={githubUrl} target="_blank" shape="circle" variant="text" aria-label="Open TDesign React on GitHub">
                <LogoGithubIcon />
              </Button>
            </Tooltip>
            <Tooltip content={isDark ? 'Switch to light theme' : 'Switch to dark theme'}>
              <Button shape="circle" variant="text" aria-label={isDark ? 'Switch to light theme' : 'Switch to dark theme'} onClick={toggleTheme}>
