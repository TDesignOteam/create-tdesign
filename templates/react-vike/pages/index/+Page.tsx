...
const tasks = [
  ...
  { title: 'Shape the application shell', detail: 'Edit pages/index/+Page.tsx and the layout to match your product.' },
        ...
        <div className="topbar-inner">
          ...
          <div className="topbar-actions">
            <Tooltip content="React component documentation">
              <Button tag="a" href={docsUrl} target="_blank" shape="circle" variant="text" aria-label="Open React component documentation"><BookOpenIcon /></Button>
            </Tooltip>
            <Tooltip content="TDesign React on GitHub">
              <Button tag="a" href={githubUrl} target="_blank" shape="circle" variant="text" aria-label="Open TDesign React on GitHub"><LogoGithubIcon /></Button>
            </Tooltip>
            <Tooltip content={isDark ? 'Switch to light theme' : 'Switch to dark theme'}>
              <Button shape="circle" variant="text" aria-label={isDark ? 'Switch to light theme' : 'Switch to dark theme'} onClick={toggleTheme}>{isDark ? <SunnyIcon /> : <MoonIcon />}</Button>
            </Tooltip>
          </div>
        </div>
      </header>
      ...
      <main className="workspace">
        <section className="welcome" aria-labelledby="starter-title">
          <div className="welcome-copy">
            <Tag theme="primary" variant="light">__TEMPLATENAME__</Tag>
          ...
          <a className="docs-action" href={docsUrl} target="_blank" rel="noreferrer">Explore components <ArrowRightIcon /></a>
        </section>

        <section className="command-panel" aria-label="Development command">
          <span className="command-icon"><CodeIcon /></span>
          <div className="command-copy"><span>Development command</span><code>__DEVCOMMAND__</code></div>
          <Tag className="ready-tag" theme="success" variant="light">Ready</Tag>
        </section>
          ...
          {overview.map((item) => {
            ...
            return (
              <Card key={item.label} className="overview-card" bordered>
                <span className="overview-icon"><ItemIcon /></span>
        ...
        <section className="work-grid">
          <Card className="work-card" title="Getting started" bordered actions={<span className="section-status"><span className="status-dot" />Project initialized</span>}>
          ...
          <Card className="work-card resources-card" title="Resources" bordered>
            <a href="/dependencies">
              ...
              <span><strong>Dependencies</strong><small>Review runtime and development packages</small></span><ChevronRightIcon />
            </a>
            <a href={docsUrl} target="_blank" rel="noreferrer">
              <span className="resource-icon"><BookOpenIcon /></span>
              <span><strong>Component docs</strong><small>APIs, examples, and design guidance</small></span><ChevronRightIcon />
            </a>
            <a href={githubUrl} target="_blank" rel="noreferrer">
              <span className="resource-icon"><LogoGithubIcon /></span>
              <span><strong>GitHub repository</strong><small>Source, issues, and releases</small></span><ChevronRightIcon />
            </a>
            <a href="https://tdesign.tencent.com/" target="_blank" rel="noreferrer">
              <span className="resource-icon resource-icon-green"><BrowseIcon /></span>
              <span><strong>TDesign overview</strong><small>Explore the full design system</small></span><ChevronRightIcon />
            </a>
          </Card>
        </section>
      </main>
