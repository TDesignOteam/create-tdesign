...
const overview = [
  { icon: CodeIcon, label: 'Application', value: 'Vue 3 + TSX + Vike' },
        ...
        <div class="topbar-inner">
          ...
          <div class="topbar-actions">
            <TTooltip content="Vue component documentation">
              <TButton tag="a" href={docsUrl} shape="circle" variant="text" aria-label="Open Vue component documentation"><BookOpenIcon /></TButton>
            </TTooltip>
            <TTooltip content="TDesign Vue on GitHub">
              <TButton tag="a" href={githubUrl} shape="circle" variant="text" aria-label="Open TDesign Vue on GitHub"><LogoGithubIcon /></TButton>
            </TTooltip>
            <TTooltip content={isDark.value ? 'Switch to light theme' : 'Switch to dark theme'}>
              <TButton shape="circle" variant="text" aria-label={isDark.value ? 'Switch to light theme' : 'Switch to dark theme'} onClick={toggleTheme}>{isDark.value ? <SunnyIcon /> : <MoonIcon />}</TButton>
            </TTooltip>
          </div>
        </div>
      </header>
