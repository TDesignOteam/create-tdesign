        ...
        <TCol>
          <TSpace align="center" :size="4">
            ...
            <TTooltip :content="isDark ? 'Use light theme' : 'Use dark theme'">
              <TButton shape="circle" variant="text" :aria-label="isDark ? 'Use light theme' : 'Use dark theme'" @click="toggleTheme">
              ...
              <TCard class="dependencies-card" :header-bordered="true">
                ...
                <TList split>
                  <TListItem v-for="[name, version] in group.items" :key="name">
                    ...
                    <template #action><TypographyText class="dependency-version" code copyable>{{ version }}</TypographyText></template>
                  </TListItem>
                </TList>
              </TCard>
            </TCol>
